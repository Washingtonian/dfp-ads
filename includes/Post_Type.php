...
class Post_Type
{
	...
	public function add_meta_boxes()
	{
		...
		$this->metaboxes[0]['callback']      = [$this, 'settings_box'];
		$this->metaboxes[0]['callback_args'] = $post->ID;
		foreach ($this->metaboxes as $box) {
			add_meta_box($box['id'], $box['title'], $box['callback'], $box['name'], $box['context'], $box['priority']);
		}
	}
	...
	public function save_meta_box($post_id)
	{
		...
		if (wp_is_post_autosave($post_id) || wp_is_post_revision($post_id) || ! $this->verify_nonce()) {
