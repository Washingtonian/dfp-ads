...
window.onload = function () {
    if (document.getElementsByTagName("body")[0].getAttribute("class") !== undefined && document.getElementsByTagName("body")[0].getAttribute("class").match(/pet-resources|city-guides|home/)) {
